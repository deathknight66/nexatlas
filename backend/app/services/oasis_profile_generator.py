...
logger = get_logger('nexatlas.oasis_profile')
...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are an enterprise consulting profile expert for NexAtlas. Generate detailed, realistic professional personas for business advisory simulations. Return valid JSON only, no unescaped newlines in string values."
