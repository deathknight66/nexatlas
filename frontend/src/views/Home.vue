<template>
  <div class="home-container">
    <!-- 顶部导航栏 -->
    <nav class="navbar">
      <div class="nav-brand">NEXATLAS</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <a href="https://github.com/666ghj/NexAtlas" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/NexAtlas_logo_left.jpeg" alt="NexAtlas Logo" class="hero-logo" />
          </div>
